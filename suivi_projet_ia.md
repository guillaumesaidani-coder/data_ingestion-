...
> Template de suivi calé sur le cycle de vie d'un projet IA. 
Chaque phase liste les tâches, les **technos / outils** à utiliser et les artefacts à produire. 
À dupliquer pour chaque nouveau projet.
...
| **Brief du projet** | contexte_à synthétiser_ |
...
## 1 · Cadrage *(🔵)* sprint 1 - à affiner au fil du temps
...
📦 **Artefacts** : note de cadrage = spec de base · datasheet initiale · liste des KPI
**Statut** : _____

---

## 2 · Données — ingestion & gouvernance *(🟡)* sprint 1

**Objectif** : collecter, modéliser et versionner les données de façon traçable.

- [ ] Mettre en place l'environnement et le versioning de code (GIT + DBC)
...
## 3 · Exploration & profiling *(🟡)* sprint 1
...
## 4 · Préparation & nettoyage *(🟡)* sprint 1
...
## 5 · Feature engineering *(🟡)* sprint 1
...
## 6 · Baseline & protocole d'évaluation *(🟡)* boucle sprint 2
...
## 7 · Choix & entraînement du modèle *(🟡)* boucle sprint 2
