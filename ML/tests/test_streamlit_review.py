...
def test_refine_false_alarm_writes_reclassification(tmp_path, monkeypatch):
    ...
    at.radio(key="verdict_fausse_alerte").set_value("Capteur défaillant")
    ...
    assert row.review_status == "CAPTEUR_DEFAILLANT"
